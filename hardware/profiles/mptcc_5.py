            ...
            "instances": [
                {
                    ...
                    "vu_meter_colors": [
                        ...
                        [0, 255, 0],      # LED 29
                        [0, 255, 0],      # LED 30
                        [128, 255, 0],    # LED 31: Transition (green to yellow)
                        [255, 255, 0],    # LED 32: Transition (matches yellow)
                        [255, 255, 0],    # LED 33: Yellow
                        [255, 255, 0],    # LED 34
                        [255, 255, 0],    # LED 35
                        [255, 255, 0],    # LED 36
                        [255, 210, 0],    # LED 37: Transition (yellow to orange)
                        [255, 165, 0],    # LED 38: Transition (matches orange)
                        [255, 165, 0],    # LED 39: Orange
                        [255, 165, 0],    # LED 40
                        [255, 165, 0],    # LED 41
                        [255, 165, 0],    # LED 42
                        [255, 83, 0],     # LED 43: Transition (orange to red)
                        [255, 0, 0],      # LED 44: Transition (matches red)
                        [255, 0, 0],      # LED 45: Red
                        [255, 0, 0],      # LED 46
                        [255, 0, 0],      # LED 47
                        [255, 0, 0]       # LED 48
