...
hardware/output/mcp23017_bitbang.py
...
class MCP23017(Output):
    ...
    def __init__(self):
        ...
        # Dynamically initialize Output_MCP23017 instances based on NUMBER_OF_COILS
        self.output = []
        for i in range(1, self.init.NUMBER_OF_COILS + 1):
            ...
            # Initialize the Output_MCP23017 instance
            self.output.append(Output_MCP23017(self.i2c, self.MCP23017_ADDR, pin, self.init.i2c_mutex))
