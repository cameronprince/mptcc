...
leds = [
    RGBLed(pca, red_channel=0, green_channel=1, blue_channel=8),
    RGBLed(pca, red_channel=2, green_channel=3, blue_channel=9),
    RGBLed(pca, red_channel=4, green_channel=5, blue_channel=10),
    RGBLed(pca, red_channel=6, green_channel=7, blue_channel=11),
]
